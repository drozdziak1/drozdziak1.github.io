...
```
Your output should look something like mine, with a `/ #` shell prompt hidden
...
Congratulations! :confetti_ball: Believe it or not, but what you just did in this
tutorial was creating a tiny Linux-based operating system. Even though you
didn't write any code, you managed to create something useful that will later on
help you safely test your stuff.
