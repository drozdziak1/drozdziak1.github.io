...
# Coding style
Before we start writing code it's important to mention the preferred coding
guidelines in Linux. Some of the most important rules involve:
* **8 space wide tabs** - vim-sleuth (?)
* **80 column width limit** (with exceptions if a longerline is really worth it)
* **When in doubt, follow the K&R style**
