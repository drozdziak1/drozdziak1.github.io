...
for speeding up driver development and systems that frown upon downtimes.
Today, we're going to harness that power to write module that will print two
...
# Coding style
Before we start writing code it's important to mention the code guidelines of
Linux Some of the most important rules involve:
* 8 space wide tabs (and how `vim-sleuth` can help)
* 80 column width limit (with exceptions if a longerline is really worth it)
* When in doubt, comply with K&R
