...
# Coding style
Before we start writing code it's important to mention *how* to write it. Some
of the most important rules involve:
...
* **When in doubt, comply with K&R** - When Brian Kernighan and Dennis Ritchie
  wrote "The C programming language", they also established a robust standard
  for coding style of the language
